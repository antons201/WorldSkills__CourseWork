...
class Ui_AdminWindow(object):
    def setupUi(self, AdminWindow):
        ...
        self.NameChempionshipsLabel_3 = QtWidgets.QLabel(self.MainFrame)
        self.NameChempionshipsLabel_3.setGeometry(QtCore.QRect(620, 20, 81, 16))
        self.NameChempionshipsLabel_3.setObjectName("NameChempionshipsLabel_3")
        self.ThisChempionshipsLabel_3 = QtWidgets.QLabel(self.MainFrame)
        self.ThisChempionshipsLabel_3.setGeometry(QtCore.QRect(620, 0, 141, 16))
        ...
        self.ManageChempionshipsFrame.setGeometry(QtCore.QRect(19, 9, 761, 501))
        ...
        self.ChempionshipsLabel.setGeometry(QtCore.QRect(70, 180, 91, 16))
        ...
        self.ThisChempionshipsLabel = QtWidgets.QLabel(self.ManageChempionshipsFrame)
        self.ThisChempionshipsLabel.setGeometry(QtCore.QRect(620, 0, 141, 16))
        self.ThisChempionshipsLabel.setObjectName("ThisChempionshipsLabel")
        self.NameChempionshipsLabel = QtWidgets.QLabel(self.ManageChempionshipsFrame)
        self.NameChempionshipsLabel.setGeometry(QtCore.QRect(620, 20, 81, 16))
        self.NameChempionshipsLabel.setObjectName("NameChempionshipsLabel")
        self.CompetitorFrame = QtWidgets.QFrame(self.centralwidget)
        self.CompetitorFrame.setGeometry(QtCore.QRect(19, 9, 761, 501))
        ...
        self.CompetitorLabel.setGeometry(QtCore.QRect(80, 180, 81, 16))
        ...
        self.NameChempionshipsLabel_2 = QtWidgets.QLabel(self.CompetitorFrame)
        self.NameChempionshipsLabel_2.setGeometry(QtCore.QRect(620, 20, 81, 16))
        self.NameChempionshipsLabel_2.setObjectName("NameChempionshipsLabel_2")
        self.ThisChempionshipsLabel_2 = QtWidgets.QLabel(self.CompetitorFrame)
        self.ThisChempionshipsLabel_2.setGeometry(QtCore.QRect(620, 0, 141, 16))
    ...
    def retranslateUi(self, AdminWindow):
        ...
        self.NameChempionshipsLabel_3.setText(_translate("AdminWindow", "название"))
        self.ThisChempionshipsLabel_3.setText(_translate("AdminWindow", "Текущий чемпионат:"))
...
" к чемпионату"))
        self.ChempionshipsLabel.setText(_translate("AdminWindow", "Чемпионаты"))
        ...
        self.CompetitorLabel.setText(_translate("AdminWindow", "Участники"))
        ...
        self.NameChempionshipsLabel_2.setText(_translate("AdminWindow", "название"))
        self.ThisChempionshipsLabel_2.setText(_translate("AdminWindow", "Текущий чемпионат:"))
