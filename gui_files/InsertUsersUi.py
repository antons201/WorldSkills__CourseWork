...
class Ui_InsertUsers(object):
    def setupUi(self, InsertUsers):
        ...
        self.CompetitionLabel.setGeometry(QtCore.QRect(0, 210, 81, 16))
        ...
        self.ChempionshipLabel = QtWidgets.QLabel(InsertUsers)
        self.ChempionshipLabel.setGeometry(QtCore.QRect(14, 180, 71, 20))
        ...
        self.ChempionshipComboBox = QtWidgets.QComboBox(InsertUsers)
        self.ChempionshipComboBox.setGeometry(QtCore.QRect(100, 180, 73, 22))
        self.ChempionshipComboBox.setObjectName("ChempionshipComboBox")
        self.CompetenceComboBox = QtWidgets.QComboBox(InsertUsers)
        self.CompetenceComboBox.setGeometry(QtCore.QRect(100, 210, 73, 22))
    ...
    def retranslateUi(self, InsertUsers):
        ...
        self.ChempionshipLabel.setText(_translate("InsertUsers", "Чемпионат"))
