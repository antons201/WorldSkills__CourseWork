...
class Ui_CompetitorWindow(object):
    def setupUi(self, CompetitorWindow):
        ...
        self.NameChempionshipsLabel = QtWidgets.QLabel(self.MainFrame)
        self.NameChempionshipsLabel.setGeometry(QtCore.QRect(570, 30, 81, 16))
        self.NameChempionshipsLabel.setObjectName("NameChempionshipsLabel")
        self.ThisChempionshipsLabel = QtWidgets.QLabel(self.MainFrame)
        self.ThisChempionshipsLabel.setGeometry(QtCore.QRect(570, 10, 141, 16))
        ...
        self.NameChempionshipsLabel_4 = QtWidgets.QLabel(self.ResultsFrame)
        self.NameChempionshipsLabel_4.setGeometry(QtCore.QRect(570, 30, 81, 16))
        self.NameChempionshipsLabel_4.setObjectName("NameChempionshipsLabel_4")
        self.ThisChempionshipsLabel_4 = QtWidgets.QLabel(self.ResultsFrame)
        self.ThisChempionshipsLabel_4.setGeometry(QtCore.QRect(570, 10, 141, 16))
        ...
        self.NameChempionshipsLabel_3 = QtWidgets.QLabel(self.MyProfileFrame)
        self.NameChempionshipsLabel_3.setGeometry(QtCore.QRect(570, 30, 81, 16))
        self.NameChempionshipsLabel_3.setObjectName("NameChempionshipsLabel_3")
        self.ThisChempionshipsLabel_3 = QtWidgets.QLabel(self.MyProfileFrame)
        self.ThisChempionshipsLabel_3.setGeometry(QtCore.QRect(570, 10, 141, 16))
        ...
        self.NameChempionshipsLabel_2 = QtWidgets.QLabel(self.CompetitionFrame)
        self.NameChempionshipsLabel_2.setGeometry(QtCore.QRect(570, 30, 81, 16))
        self.NameChempionshipsLabel_2.setObjectName("NameChempionshipsLabel_2")
        self.ThisChempionshipsLabel_2 = QtWidgets.QLabel(self.CompetitionFrame)
        self.ThisChempionshipsLabel_2.setGeometry(QtCore.QRect(570, 10, 141, 16))
    ...
    def retranslateUi(self, CompetitorWindow):
        ...
        self.NameChempionshipsLabel_4.setText(_translate("CompetitorWindow", "название"))
        self.ThisChempionshipsLabel_4.setText(_translate("CompetitorWindow", "Текущий чемпионат:"))
        ...
        self.NameChempionshipsLabel_3.setText(_translate("CompetitorWindow", "название"))
        self.ThisChempionshipsLabel_3.setText(_translate("CompetitorWindow", "Текущий чемпионат:"))
        ...
        self.NameChempionshipsLabel_2.setText(_translate("CompetitorWindow", "название"))
        self.ThisChempionshipsLabel_2.setText(_translate("CompetitorWindow", "Текущий чемпионат:"))
