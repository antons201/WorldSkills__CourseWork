...
class Ui_CoordinatorWindow(object):
    def setupUi(self, CoordinatorWindow):
        ...
        self.ThisChempionshipsLabel.setGeometry(QtCore.QRect(610, 10, 141, 16))
        ...
        self.NameChempionshipsLabel.setGeometry(QtCore.QRect(610, 30, 81, 16))
        ...
        self.NameChempionshipsLabel_2 = QtWidgets.QLabel(self.VolunteersFrame)
        self.NameChempionshipsLabel_2.setGeometry(QtCore.QRect(610, 30, 81, 16))
        self.NameChempionshipsLabel_2.setObjectName("NameChempionshipsLabel_2")
        self.ThisChempionshipsLabel_2 = QtWidgets.QLabel(self.VolunteersFrame)
        self.ThisChempionshipsLabel_2.setGeometry(QtCore.QRect(610, 10, 141, 16))
    ...
    def retranslateUi(self, CoordinatorWindow):
        ...
        self.ThisChempionshipsLabel.setText(_translate("CoordinatorWindow", "Текущий чемпионат:"))
        self.NameChempionshipsLabel.setText(_translate("CoordinatorWindow", "название"))
